...
- (void)forgetPwdBtnClick {
    [self.navigationController pushViewController:[LCLForgetPasswordViewController1 new] animated:YES];
}

#pragma mark - 登录页面
- (void)registerBtnClick {
    [self.navigationController pushViewController:[LCLRegisterViewController1 new] animated:YES];
}
