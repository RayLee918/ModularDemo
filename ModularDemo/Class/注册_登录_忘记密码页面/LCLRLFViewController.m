...
#import "LCLRLFViewController.h"
#import "LCLLoginViewController1.h"
#import "LCLLoginViewController2.h"
#import "LCLLoginViewController3.h"

@interface LCLRLFViewController () <UITableViewDelegate, UITableViewDataSource>
{
...
@implementation LCLRLFViewController
...
#pragma mark - 加载数据
- (void)loadNewData {
    _titles = @[@"注册_登录_忘记密码 - 1", @"注册_登录_忘记密码 - 2", @"注册_登录_忘记密码 - 3"];
    _dataSource = @[[LCLLoginViewController1 class], [LCLLoginViewController2 class], [LCLLoginViewController3 class]];
}
